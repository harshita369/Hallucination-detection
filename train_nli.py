...
HOW TO RUN:
  ...
  Wait for Phase 3 to finish first since both need the GPU.
=============================================================
"""
...
# Fill any remaining nulls and ensure correct types
...
model = AutoModelForSequenceClassification.from_pretrained(
    ...
    use_cache  = False    # required for gradient checkpointing — silences warning
)
...
# Defined before if __name__ so it is always available
# =============================================================
...
# Everything inside if __name__ — required for Linux multiprocessing
# =============================================================
...
if __name__ == "__main__":
    ...
    for epoch in range(1, CONFIG["epochs"] + 1):
        ...
        print(f"    Entailment     : "
              f"precision={report['Entailment']['precision']:.3f}  "
              f"recall={report['Entailment']['recall']:.3f}")
        print(f"    Neutral        : "
              f"precision={report['Neutral']['precision']:.3f}  "
              f"recall={report['Neutral']['recall']:.3f}")
        print(f"    Contradiction  : "
              f"precision={report['Contradiction']['precision']:.3f}  "
              f"recall={report['Contradiction']['recall']:.3f}")
