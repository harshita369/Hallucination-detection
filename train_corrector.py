...
class CorrectionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Tokenize target output using text_target keyword
        # (as_target_tokenizer was removed in newer transformers)
...
# Defined here (before if __name__) so it's always accessible
# =============================================================
